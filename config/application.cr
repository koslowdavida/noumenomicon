...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Noumenomicon web application."
  #
  #
  ...
  #
  # settings.secret_key_base= CgkMZ6OAA177iB1s9Nu0gWVCdPojRMYh0epolq8eYdg
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("noumenomicon.log", "w"))
  #
  #
end
